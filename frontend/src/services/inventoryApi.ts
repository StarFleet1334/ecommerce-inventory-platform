import type { ProductMessage, ApiResponse } from "../types/inventory";
...
class InventoryApiService {
  ...
  async createProduct(
    ...
    return this.request<ApiResponse>(
      `/api/v1/product?initialLoad=${initialLoad}`,
      {
        method: "POST",
  ...
  async createCustomer(
    ...
    return this.request<ApiResponse>(
      `/api/v1/customer?initialLoad=${initialLoad}`,
      {
        method: "POST",
  ...
  async createEmployee(
    ...
    return this.request<ApiResponse>(
      `/api/v1/employee?initialLoad=${initialLoad}`,
      {
        method: "POST",
  ...
  async createStock(
    ...
    return this.request<ApiResponse>(
      `/api/v1/stock?initialLoad=${initialLoad}`,
      {
        method: "POST",
  ...
  async createSupplier(
    ...
    return this.request<ApiResponse>(
      `/api/v1/supplier?initialLoad=${initialLoad}`,
      {
        method: "POST",
  ...
  async createWarehouse(
    ...
    return this.request<ApiResponse>(
      `/api/v1/warehouse?initialLoad=${initialLoad}`,
      {
        method: "POST",
  ...
  async createSupply(
    ...
    return this.request<ApiResponse>(
      `/api/v1/supply?initialLoad=${initialLoad}`,
      {
        method: "POST",
